function [Volt, Angle, error_avg, L_next, U_next, J_next,...
    J_ordered_next] = NewtonRhapson(tolerance, n_bus, n_pv, n_pq,...
    pq_bus_id, V, delta, Y_next, Y_first, Ps, Qs, Scheme)
    ...
    while any(abs(mismatch(:)) > tolerance)
        ...
        [ordering_idx, original_idx, J_ordered_next] = ...
        ...
        [error, L_next, U_next] = Sparse_LU(J_next,J_first,mismatch,...
            ordering_idx);
